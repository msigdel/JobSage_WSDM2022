...
\end{tabular}
  ...
  \begin{minipage}[b]{0.49\textwidth}
    ...
    \captionof{figure}{t-SNE plot of job embedding vectors from DWGCN-GCN which are color-labeled by carotene catogories and annotated with normalized job titles}
    \label{fig:data_vis}
  \end{minipage}
  \end{minipage}
  \vspace{0em}
